...
import { FaCross, FaCalendarDays, FaPeopleGroup, FaUser } from "react-icons/fa6";
...
export function Navbar(){
    ...
    return(
        <>
            {/* Navbar lateral */}
            <nav className="max-w-52 w-full h-full bg-[#41414163] py-6">
                <ul className="w-full h-full flex flex-col items-center justify-between">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        type="button"
                        onClick={logout}
                        className="w-full p-2 bg-red-600 text-white rounded-2xl cursor-pointer hover:scale-105 transition-all">Logout</button>
                    </div>
                </ul>
            </nav>
        </>
