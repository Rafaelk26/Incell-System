...
export default function Supervisoes() {
  const { user } = useAuth()
  const [supervisoes, setSupervisoes] = useState<SupervisaoProps[]>([]);
  ...
  async function buscarSupervisoes() {
    ...
    if (supervisoes) setSupervisoes(supervisoes);
    setLoading(false);
  }
        ...
        <main className="max-w-[84rem] w-full overflow-x-hidden xl:mx-auto px-4">
          ...
          <section className="max-w-full w-full mt-10 md:mt-14 mb-10">
            ...
            md:flex-row md:w-full md:mx-0 md:mt-6">
              ...
              placeholder="Nome da Supervisão" />
                ...
                md:w-full">
                  <thead>
                    <tr className="bg-zinc-950/90 text-white font-normal font-manrope">
                      <th className="p-3 text-left rounded-tl-xl">Nome de Supervisão</th>
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-3 py-2 font-manrope font-light text-center">
                                <Link
                                  href={`/coordenacao/supervisor/${item.id}`}
                                >
